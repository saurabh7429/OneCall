...
public final class ItemDeviceBinding implements ViewBinding {
  ...
  private ItemDeviceBinding(@NonNull CardView rootView, @NonNull MaterialButton btnConnect,
  ...
  public static ItemDeviceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemDeviceBinding((CardView) rootView, btnConnect, tvDeviceAddress, tvDeviceName);
    }
